	...
	if (Platform.OS !== 'web'){
		return (
			<TabBottom.Navigator initialRouteName={AppRoute.NEWS}>
				...
				<TabBottom.Screen name={AppRoute.PEOPLE} component={PeopleScreen}  options={{ title: t('People'), tabBarIcon: LayoutIcon }} />
				<TabBottom.Screen name={AppRoute.SCHEDULE} component={ScheduleScreen}  options={{ title: t('Schedule'), tabBarIcon: LayoutIcon }} />
			</TabBottom.Navigator>
		)
	} else {
		return (
			<TabTop.Navigator initialRouteName={AppRoute.NEWS}>
				...
				<TabTop.Screen name={AppRoute.SCHEDULE} component={ScheduleScreen}  options={{ title: t('Schedule'), tabBarIcon: LayoutIcon }} />
			</TabTop.Navigator>
		);
	}
};
